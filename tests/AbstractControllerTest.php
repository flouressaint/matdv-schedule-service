...
abstract class AbstractControllerTest extends WebTestCase
{
    ...
    protected function createTeacher(string $username, string $password): User
    {
        return $this->createUserWithRoles($username, $password, ['ROLE_TEACHER']);
    }
    ...
    protected function createTeacherAndAuth(string $username, string $password): User
    {
        $user = $this->createTeacher($username, $password);
        $this->auth($username, $password);
